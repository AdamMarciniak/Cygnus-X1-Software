...
#define LSM9DS1_AG_ADDR(sa0) ((sa0) == 1 ? 0x6B : 0x6B)
#define LSM9DS1_M_ADDR(sa1) ((sa1) == 1 ? 0x1E : 0x1E)
...
public:
	...
	uint16_t begin(uint8_t agAddress = LSM9DS1_AG_ADDR(1), uint8_t mAddress = LSM9DS1_M_ADDR(1), TwoWire &wirePort = Wire1); //By default use the default I2C addres, and use Wire port
