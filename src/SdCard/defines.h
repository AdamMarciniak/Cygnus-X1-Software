...
#define CHIP_SELECT digitalWrite(SS_FLASH, LOW);
#define CHIP_DESELECT digitalWrite(SS_FLASH, HIGH);
...
#else
#define SPI_CLK 10400000 //Hz equivalent of 104MHz
#endif
...
#define setLowerNibble(x, y) \
  x &= 0xF0;                 \
  x |= (y & 0x0F) // Clear out the lower nibble // OR in the desired mask
#define setUpperNibble(x, y) \
  x &= 0x0F;                 \
  x |= (y & 0xF0) // Clear out the lower nibble // OR in the desired mask
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
